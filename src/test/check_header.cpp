...
crack_t crypt_tests[10] = {
    {
        ...
        0, 0, // start, end
            {
                12431, 1570651783, 1570639368, // pid, time, seed
                { 0x348e6771, 0xcecf3c76, 0x51a09805 }, // keys
                { // files
                    { // 1st file
        ...
        0, 0, // start, end
            {
                13715, 1570652412, 1570665839, // pid, time, seed
                { 0x36718a59, 0x8f33c8ee, 0xdea1bb9d }, // keys
                { // files
                    { // 1st file
        ...
        0, 0, // start, end
            {
                13974, 1570652566, 1570666240, // pid, time, seed
                { 0x1fbf04f9, 0x755b317c, 0x2a7b0b67 }, // keys
                { // files
                    { // 1st file
        ...
        0, 0, // start, end
            {
                14164, 1570652674, 1570665814, // pid, time, seed
                { 0x76cf6e60, 0x55abd9be, 0x02f6bd0a }, // keys
                { // files
                    { // 1st file
