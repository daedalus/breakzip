...
namespace gpu_stage3 {
    ...
    void gpu_stage3(const mitm::archive_info &info, const mitm_stage2::stage2_candidate &c2,
                	/* output */ std::vector<keys> &k, const mitm::correct_guess *c = nullptr);
	...
	void gpu_stage4(const mitm::archive_info &info,
	                ...
	                uint32_t crck00, uint32_t k20, /* output */ std::vector<keys> &k,
