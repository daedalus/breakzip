...
int main(int argc, char *argv[]) {
    ...
    checkCudaErrors(cusolverSpDcsrcholZeroPivotHost(cusolverSpH, h_info, tol,
                                                    &singularity));
    ...
    checkCudaErrors(cusolverSpDcsrcholSolveHost(cusolverSpH, rowsA, h_b, h_x,
                                                h_info, buffer_cpu));
    ...
    checkCudaErrors(cusolverSpDcsrcholFactor(cusolverSpH, rowsA, nnzA, descrA,
                                             d_csrValA, d_csrRowPtrA,
                                             d_csrColIndA, d_info, buffer_gpu));

    printf("step 13: check if the matrix is singular \n");
    checkCudaErrors(
        cusolverSpDcsrcholZeroPivot(cusolverSpH, d_info, tol, &singularity));
    ...
    checkCudaErrors(cusolverSpDcsrcholSolve(cusolverSpH, rowsA, d_b, d_x,
                                            d_info, buffer_gpu));
