...
public:
    static Npp8u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_8u_C1(nWidth, nHeight,
                                       reinterpret_cast<int *>(pPitch));
...
public:
    static Npp8u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_8u_C2(nWidth, nHeight,
                                       reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp8u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_8u_C3(nWidth, nHeight,
                                       reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp8u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_8u_C4(nWidth, nHeight,
                                       reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp16u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_16u_C1(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp16u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_16u_C2(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp16u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_16u_C3(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp16u *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_16u_C4(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp16s *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_16s_C1(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp16s *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_16s_C2(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp16s *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_16s_C4(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp32s *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_32s_C1(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp32s *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_32s_C3(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp32s *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_32s_C4(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp32f *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_32f_C1(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp32f *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_32f_C2(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp32f *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_32f_C3(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
...
public:
    static Npp32f *Malloc2D(unsigned int nWidth, unsigned int nHeight,
        ...
        if (bTight) {
            ...
            pResult = nppiMalloc_32f_C4(nWidth, nHeight,
                                        reinterpret_cast<int *>(pPitch));
            NPP_ASSERT(pResult != 0);
        }
