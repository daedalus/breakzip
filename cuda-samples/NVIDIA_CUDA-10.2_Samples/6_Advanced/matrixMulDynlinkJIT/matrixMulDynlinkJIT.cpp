...
CUresult initCUDA(int argc, char **argv, CUfunction *pMatrixMul,
    ...
    *block_size_out = block_size;
    ...
    // setup JIT compilation options and perform compilation
    {
        ...
        status =
            cuModuleLoadDataEx(&cuModule, matrixMul_kernel_64_ptxdump,
                               jitNumOptions, jitOptions, (void **)jitOptVals);
#else
        status =
            cuModuleLoadDataEx(&cuModule, matrixMul_kernel_32_ptxdump,
                               jitNumOptions, jitOptions, (void **)jitOptVals);
#endif
...
int main(int argc, char **argv) {
    ...
    {
        // This is the older CUDA Driver API for Kernel Parameter passing and
        // Kernel Launching
        int offset = 0;
        {
