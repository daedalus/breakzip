...
void ParticleRenderer::display() {
    ...
    mat_perspective(projection, 60,
                    (float)m_windowWidth / (float)m_windowHeight, 0.1, 1000.0);
    ...
    glUniform4f(h_SecondaryColor, m_baseColor[0], m_baseColor[1],
                m_baseColor[2], m_baseColor[3]);
